...
<head>
    ...
    <meta name="description" content="Retention Policy Management - College of Criminal Justice">
        ...
        <main class="dashboard-container" id="mainContent" role="main">
            ...
            <section class="card welcome-card" aria-label="Welcome Section">
                <div class="welcome-content">
                    <h2>Retention Policy Submissions</h2>
                    <p>Review Letters of Undertaking for students with 3 or more failed subjects.</p>
                </div>
            </section>
