...
$concerns = [];
if (!empty($student_no)) {
    $stmt = $conn->prepare("SELECT * FROM student_concerns WHERE student_no = ? ORDER BY id DESC LIMIT ?");
    if ($stmt) {
                ...
                <div class="table-responsive">
                    <table class="status-table">
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="5" style="text-align: center; color: #64748b; padding: 25px;">No concern records found. Click "Submit Concern" to raise one.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
